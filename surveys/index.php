 ...
 * 
 * @package SurveySez
 * @author Scott Allen <scallen85@gmail.com>
 * @version 0.1 2018/05/08
 * @link http://www.scallen.rocks/
...
{#records exist - process
	...
	{# process each row
         echo '<div align="center"><a href="' . VIRTUAL_PATH . 'surveys/surveys_view.php?id=' . (int)$row['SurveyID'] . '">' . dbOut($row['Title']) . '</a>';
         echo '</div>';
	}
